...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <center>
                <span><img src = "{{asset('public/user/assets/images/check.png')}}" class = "check-icon" /> &nbsp;
                    &nbsp;
                    &nbsp;
                    &nbsp;
                    <span class = "actice-status"><b>Active Subscription</b></span></span><h6>You're subscribed</h6></br>
            </center>      
