...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        <title>Dispatch Coffee</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css">
        <link rel="stylesheet" href="{{asset('public/user/assets/style.css')}}">
        <link rel="alternate shortcut icon" href="https://images.ctfassets.net/ae3vwi9ownxw/1aUVGNRbKZ61qub8BGltRx/a6823176c95c674c7e2032dde36dc2bf/favicon-32x32.png" type="image/png"/>
            ...
            <div class="header-bottom">
                <div class="container">
                    <div class="row">
                        <div class="col-md-5">
                            <nav>
                                <!--                                <a class="button button--tight" href="subscribe.html">Try a subscription</a>
                                                                <a class="" href="gift-subscription.html">Gift Subscriptions</a></nav>-->
                        </div>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <nav><a class="strong" href="javascript:void(0)">Build a subscription</a><a class="" href="gift-subscription.html">Gift a subscription</a><a class="strong" href="collections/all.html">Shop</a><a class="" href="collections/coffee.html">Whole Bean Coffee</a><a class="" href="collections/equipment.html">Equipment</a></nav>
                    </div>
                    <div class="col-md-3 abt">
                        <nav><a class="strong" href="javascript:void(0)">About us</a><a class="" href="about-us.html">Our story</a><a class="" href="locations-and-services.html">Our cafes</a><a class="" href="help-and-faq.html">Get in touch &amp; F.A.Q</a><a class="" href="workwithus.html">Work with us</a></nav>
                    </div>
                    <div class="col-md-2">
                        <nav><a class="strong" href="javascript:void(0)">Impact</a><a class="strong" href="brewing.html">How to brew</a></nav>
                    </div>
                    <div class="col-md-2 social-icon">
                        <nav>
                            <div><strong>Social</strong></div>
                            <a href="#" class="inline_block" target="_blank" rel="noopener noreferrer" title="Facebook">
                                <svg class="icon icon--facebook" viewBox="0 0 21 22">
                                <path d="M11.4,21V13.6H8.6V10.5h2.8V7.85A4.21,4.21,0,0,1,15.75,3.5H18V6.6H16.1a1.57,1.57,0,0,0-1.6,1.6v2.3h3.58l-1.14,3.1H14.5V21h4.4a1.57,1.57,0,0,0,1.6-1.6V2.6A1.57,1.57,0,0,0,18.9,1H2.1A1.57,1.57,0,0,0,.5,2.6V19.4A1.57,1.57,0,0,0,2.1,21Z"></path>
                                </svg>
                            </a>
                            <a href="#" class="inline_block" target="_blank" rel="noopener noreferrer" title="Instagram">
                                <svg class="icon icon--instagram" viewBox="0 0 23 22">
                                <path d="M11.5.5C8.65.5,8.29.51,7.17.56a7.67,7.67,0,0,0-2.55.49A5.36,5.36,0,0,0,1.55,4.12a7.67,7.67,0,0,0-.49,2.55C1,7.79,1,8.15,1,11s0,3.21.06,4.33a7.67,7.67,0,0,0,.49,2.55,5.34,5.34,0,0,0,1.21,1.86A5.2,5.2,0,0,0,4.62,21a7.67,7.67,0,0,0,2.55.49c1.12,0,1.48.06,4.33.06s3.21,0,4.33-.06A7.67,7.67,0,0,0,18.38,21a5.39,5.39,0,0,0,3.07-3.07,7.67,7.67,0,0,0,.49-2.55c0-1.12.06-1.48.06-4.33s0-3.21-.06-4.33a7.67,7.67,0,0,0-.49-2.55,5.36,5.36,0,0,0-3.07-3.07A7.67,7.67,0,0,0,15.83.56C14.71.51,14.35.5,11.5.5Z"></path>
                                <path d="M11.5,5.5A5.5,5.5,0,1,0,17,11,5.5,5.5,0,0,0,11.5,5.5Z"></path>
                                <circle cx="17" cy="5.5" r="1"></circle>
                                </svg>
                            </a>
                        </nav>
                    </div>
