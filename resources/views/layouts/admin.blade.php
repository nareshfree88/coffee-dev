...
<html lang="{{app()->getLocale() }}">
    <head>
        ...
        <link href="{{asset('public/assets/plugins/nvd3/nv.d3.min.css')}}" rel="stylesheet">  
        ...
        <link href="{{asset('public/assets/plugins/datatables/css/jquery.datatables.min.css')}}" rel="stylesheet" type="text/css"/>	
        <link href="{{asset('public/assets/plugins/datatables/css/jquery.datatables_themeroller.css')}}" rel="stylesheet" type="text/css"/>	
        <link href="{{asset('public/assets/plugins/bootstrap-datepicker/css/datepicker3.css')}}" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="navbar-header">
                                <div class="logo-sm">
                                    ...
                                    <a class="logo-box" href="index.html"><span>{{config('app.name')}}</span></a>
                                </div>
...
<!--<li><a href="javascript:void(0)" class="right-sidebar-toggle" data-sidebar-id="main-right-sidebar"><i class="fa fa-envelope"></i></a></li>-->
                                    ...
                                    <li class="dropdown user-dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                            <img src="{{asset('public/assets/images/userImage.jpg')}}" alt="" class="img-circle"></a>
                                        <ul class="dropdown-menu" style="background-color: #03407c;">
                                            <!--                                            <li><a href="#">Profile</a></li>
                                                                                        <li><a href="#">Calendar</a></li>
                                                                                        <li><a href="#"><span class="badge pull-right badge-danger">42</span>Messages</a></li>
                                                                                        <li role="separator" class="divider"></li>
                                                                                        <li><a href="#">Account Settings</a></li>-->
                                            <li><a  class="" href="#" style="color: #58e500;" >
                                                    {{ ucwords(Auth::user()->name) }}
                                                </a>

                                                <!--<div class="dropdown-menu" aria-labelledby="navbarDropdown">-->
                                                <a style="color: #a5a5a5;" class="dropdown-item" href="{{ url('/logout') }}"
    ...
    document.getElementById('logout-form').submit();">
                ...
                <div class="page-inner">
                    ...
                    <div class="page-footer">
                        <p>Made with <i class="fa fa-heart"></i> Basline IT<p>
                    </div>
                </div><!-- /Page Inner -->
        ...
        <script src="{{asset('public/assets/plugins/nvd3/nv.d3.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.time.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.symbol.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.resize.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.tooltip.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/flot/jquery.flot.pie.min.js')}}"></script>
        ...
        <script src="{{asset('public/assets/js/pages/table-data.js')}}"></script>


        <script src="{{asset('public/assets/plugins/jquery-validation/jquery.validate.min.js')}}"></script>
        <script src="{{asset('public/assets/plugins/bootstrap-wizard/jquery.bootstrap.wizard.min.js')}}"></script>
        <script src="{{asset('public/assets/js/pages/form-wizard.js')}}"></script>
