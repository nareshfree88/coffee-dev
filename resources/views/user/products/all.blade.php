...
<section class="col-nav">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <nav class="col-menu">
                    <div><a class="header__link underline" href="{{url('/all')}}">Shop All</a></div>
        ...
        <div class="row" style="height:31% !important">
            <!--products-->

            @if(isset($products))
            @foreach($products as $product)
            <div class="col-md-4">
                <div class="pro-in {{($product->category == 'equipment')? 'equip':''}}">
                    ...
                    <div class="price-b">
                        <small class="brand">{{__('customlang.whole_beans')}}</small>
                        @php
