                                        ...
                                        <ul id="tm-main-nav">
                                            <li class="loca_cont" style="list-style: none;">
                                                ...
                                                <p>1237 Johnston Rd, White Rock, BC V4B 3Y8, Canada</p>
                                                 <a href="https://goo.gl/maps/D2TQXh68S8JbS17X7" target="_blank">Show on Google Maps</a>
                                                <br>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <section id="gallery" class="">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item portrait">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_9.jpg')}}" alt="Image"/></a>
                                                    </figure>  
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item building">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_24.jpg')}}" alt="Image"/></a>	
                                                    </figure>  
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item nature">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_3.jpg')}}" alt="Image"/></a>			
                                                    </figure> 
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item animal">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_10.jpg')}}" alt="Image"/></a>			
                                                    </figure>   
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item building">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_22.jpg')}}" alt="Image"/></a>		
                                                    </figure>  
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item nature">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_14.jpg')}}" alt="Image" /></a>		
                                                    </figure>   
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item portrait">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_11.jpg')}}" alt="Image"/></a>			
                                                    </figure> 
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item animal">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_5.jpg')}}" alt="Image"/></a>		
                                                    </figure>  
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item building">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_4.png')}}" alt="Image"/></a>		
                                                    </figure> 
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                    <figure class="effect-honey tm-gallery-item portrait">
                                                        <a href="#"><img src="{{asset('public/user/location/images/image_20.jpg')}}" alt="Image"/></a>			
                                                    </figure> 
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item animal">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_1.jpg')}}" alt="Image"/></a>			
                                                </figure>   
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item nature">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_2.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item animal">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_16.jpg')}}" alt="Image" style="height: 282px;"/></a>			
                                                </figure>   
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_18.jpg')}}" alt="Image"/></a>		
                                                </figure> 
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_8.jpg')}}" alt="Image"/></a>		
                                                </figure> 
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_17.jpg')}}" alt="Image"/></a>		
                                                </figure> 
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_6.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_19.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_21.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_23.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item building">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_13.jpg')}}" alt="Image"/></a>		
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="tm-gallery">
                                                <figure class="effect-honey tm-gallery-item nature">
                                                    <a href="#"><img src="{{asset('public/user/location/images/image_7.jpg')}}" alt="Image"/></a>		
                                                </figure> 
                                            </div>
                                        </div>
                                </div>
                    ...
                    <div class="more-info-parent">
                        <div class="more-info-child">
                            <ul>
                                ...
                                <li><a href="{{url('/white-rock')}}">Find a Store</a></li>
